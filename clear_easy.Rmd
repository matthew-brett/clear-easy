...
As you remember from last year, one way of assessing whether the points are close to a straight line, with a positive or negative slope, is to use *correlation*, to *test* for the relationship:
